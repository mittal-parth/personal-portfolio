    ...
    <footer id="contactMe" className="bg-gray-900 sm:px-16 px-6">
      ...
      >
        <div className={`${layout.sectionInfo}`}>
          <h2 className="text-xl font-bold text-gray-800 font-poppins dark:text-white hover:text-darkGray dark:hover:text-silverGray">
            {aboutMe.name}
          </h2>
          <p
        ...
        <div className="md:ml-auto mt-10 md:mt-0">
          <img
            src={profilePic}
            alt="Parth Mittal"
            className="w-[200px] h-[200px] border-2 border-lightTeal relative z-[5] rounded-full"
          />
        </div>
      </div>
