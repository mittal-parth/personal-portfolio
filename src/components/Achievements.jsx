        ...
        <div className={`${styles.boxWidth}`}>
          <div className="my-20 overflow-hidden">
            ...
            <div className="flex justify-end mb-4">
              <button onClick={handlePrev} disabled={isPrevDisabled} className="p-2 bg-gray-700 rounded-full disabled:opacity-50 mx-2 hover:bg-gray-600 transition-colors">
                &lt;
              </button>
              <button onClick={handleNext}
                disabled={isNextDisabled} className="p-2 bg-gray-700 rounded-full disabled:opacity-50 mx-2 hover:bg-gray-600 transition-colors" >
                &gt;
              </button>
            </div>
          </div>
  ...
  return (
    <div className="achievement-card flex-shrink-0 flex flex-col md:w-[400px] w-[320px] justify-around px-6 py-4 rounded-[20px] md:mr-10 mr-6 my-5 transition-all duration-300 transform border hover:border-purple-500 hover:shadow-lg hover:shadow-purple-500/20 dark:border-gray-700 dark:hover:border-transparent">
      ...
      <div className="flex flex-row mb-2 font-poppins font-normal text-dimWhite gap-3">
        ...
        {props.youtube && (
          <LinkPreview url={props.youtube} className="inline-flex items-center hover:text-purple-400 hover:scale-110 transition-all">
        ...
        {props.github && (
          <LinkPreview url={props.github} className="inline-flex items-center hover:text-purple-400 hover:scale-110 transition-all">
        ...
        {props.project && (
          <LinkPreview url={props.project} className="inline-flex items-center hover:text-purple-400 hover:scale-110 transition-all">
